...
class TestDirectoryStructure(unittest.TestCase):
    def setUp(self):
        ...
        self.expected_files = [
            ...
            "shorts_small_da.txt",
            "shorts_small_da.vtt",
            "DIALOGUE_parakeet_en.csv",
            "DIALOGUE_parakeet_en.docx",
            "DIALOGUE_parakeet_en.dote.json",
            "DIALOGUE_parakeet_en.json",
            "DIALOGUE_parakeet_en_merged.csv",
            "DIALOGUE_parakeet_en_merged.docx",
            "DIALOGUE_parakeet_en_merged.dote.json",
            "DIALOGUE_parakeet_en_merged.srt",
            "DIALOGUE_parakeet_en_merged.vtt",
            "DIALOGUE_parakeet_en.srt",
            "DIALOGUE_parakeet_en.tsv",
            "DIALOGUE_parakeet_en.txt",
            "DIALOGUE_parakeet_en.vtt",
            "e2etest2.zip",
            "shorts_parakeet_da.aud",
            "shorts_parakeet_da.csv",
            "shorts_parakeet_da.docx",
            "shorts_parakeet_da.dote.json",
            "shorts_parakeet_da.json",
            "shorts_parakeet_da_merged.csv",
            "shorts_parakeet_da_merged.docx",
            "shorts_parakeet_da_merged.dote.json",
            "shorts_parakeet_da_merged.srt",
            "shorts_parakeet_da_merged.vtt",
            "shorts_parakeet_da.srt",
            "shorts_parakeet_da.tsv",
            "shorts_parakeet_da.txt",
            "shorts_parakeet_da.vtt",
            "transcribe.log"
        ]
